<template>
    <TopBar ref="TopBar" />
    <Description />
    <ExampleList :selected_example="selected_example" :example_descriptions="example_descriptions_locale"
        :example_list="examples" @onSelected="selectExample" />
    <ExampleViewer ref="ExampleViewer" :selected_example="selected_example"
