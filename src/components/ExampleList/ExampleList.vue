<template>
    <div id="ExampleList">
        ...
        <ol class="options">
            ...
            <ExampleOption v-for="example in examples_loaded" :title="example_descriptions[example]['title']"
                :description="example_descriptions[example]['option_description']" :option-id="example" @onClick="select" />
        </ol>
    </div>
</template>
